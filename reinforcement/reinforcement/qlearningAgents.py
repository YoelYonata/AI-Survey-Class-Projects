...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        self.qvalues[(state,action)] = (1-self.alpha)*self.qvalues[(state, action)] + self.alpha*(self.discount*self.getValue(nextState)+reward)
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        for i in features:
          update = self.alpha * diff * features[i]
